...
from .views import (
    ...
    insight_league_capacity, insight_city_clubs, insight_retractable_roofs,
)
...
urlpatterns = [
    ...
    path("insights/retractable-roofs/", insight_retractable_roofs, name="insight_retractable_roofs"),
